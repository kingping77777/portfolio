...
<div class="research-journal-section" id="research-journal">
	<div class="header">
		<p>{m.journal_section_intro()}</p>
		<h2>{m.journal_section_heading()}</h2>
		<p class="outro">{m.journal_section_outro()}</p>
	</div>
	...
	{#if stories.length}
		<div
			...
			use:emblaCarouselSvelte={{
				...
				plugins: [Autoplay({ delay: 4000, stopOnInteraction: true }), ClassNames()]
			}}
